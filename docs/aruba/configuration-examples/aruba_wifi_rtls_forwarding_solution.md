...
This example shows the required configuration to enable [Wi-Fi RTLS data forwarding](../iot-concepts/server-connectivity/aruba_iot_transport_services.md#wi-fi-rtls-data-forwarding).
