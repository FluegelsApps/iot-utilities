...
For details about how to setup an Aruba infrastructure to be used with this app an other IoT use cases please refer to [Aruba IoT concepts and configuration](../aruba_iot_concepts_and_configuration.md).
